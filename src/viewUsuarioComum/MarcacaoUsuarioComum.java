 ...
 * @author JNCA celular
 */
public class MarcacaoUsuarioComum extends javax.swing.JFrame {

    /**
     * Creates new form Agenda
     */
    public MarcacaoUsuarioComum() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Marcação");
        setName("frameMarcacaoUsuarioComum"); // NOI18N
        setResizable(false);
    ...
    private void btnVoltarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVoltarActionPerformed
        ...
        Usuario user=new Usuario();
         if(user.getTipoUsuario()=="Admnistrador")
            {
    ...
    private void btnInserirMarcacaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInserirMarcacaoActionPerformed
        try {                                                   
            ...
            try {
                ...
                Logger.getLogger(MarcacaoUsuarioComum.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MarcacaoUsuarioComum.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MarcacaoUsuarioComum().setVisible(true);
            }
        });
    }
