 ...
 * @author JNCA celular
 */
public class ClientesUsuarioComum extends javax.swing.JFrame {

    /**
     * Creates new form Cliente
     */
    public ClientesUsuarioComum() {
        initComponents();
       setSize(800, 600);
    ...
    private void initComponents() {
        ...
        setTitle("Clientes");
        setName("frameClientesUsuarioComum"); // NOI18N
        setResizable(false);
    ...
    private void btnVoltarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVoltarActionPerformed
        ...
        MenuUsuarioComum a= new MenuUsuarioComum();
        a.setVisible(true);
        dispose();
...
//<editor-fold defaultstate="collapsed" desc=" Look and feel setting code (optional) ">
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ClientesUsuarioComum.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ClientesUsuarioComum().setVisible(true);
            }
        });
    }
